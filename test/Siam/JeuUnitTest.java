...
public class JeuUnitTest {
    ...
    public void testGetJoueurs() {
        ...
        jeu = new Jeu(joueurs[0], joueurs[1], false, false, false, false, false, false, false, null, null, null, null,
                new Musique(Theme.STANDARD), false,false,false);
    ...
    public void testIsPieceSelectionnee() {
        jeu = new Jeu(new Joueur(Camp.ELEPHANT), new Joueur(Camp.RHINOCEROS), false, false, false, false, false, false,
                false, null, null, null, null, new Musique(Theme.STANDARD), false,false,false);
    ...
    public void testGetAnimalSelectionnee() {
        ...
        jeu = new Jeu(new Joueur(Camp.ELEPHANT), new Joueur(Camp.RHINOCEROS), false, false, false, false, false, false,
                false, animal, null, null, null, new Musique(Theme.STANDARD), false,false,false);
    ...
    public void testGetFenetre() {
        ...
        jeu = new Jeu(new Joueur(Camp.ELEPHANT), new Joueur(Camp.RHINOCEROS), false, false, false, false, false, false,
                false, null, fenetre, null, null, new Musique(Theme.STANDARD), false,false,false);
    ...
    public void testGetVueJeu() {
        ...
        jeu = new Jeu(new Joueur(Camp.ELEPHANT), new Joueur(Camp.RHINOCEROS), false, false, false, false, false, false,
                false, null, null, vueJeu, null, new Musique(Theme.STANDARD), false,false,false);
    ...
    public void testGetTheme() {
        jeu = new Jeu(new Joueur(Camp.ELEPHANT), new Joueur(Camp.RHINOCEROS), false, false, false, false, false, false,
                false, null, null, null, Theme.STANDARD, new Musique(Theme.STANDARD), false,false,false);
    ...
    public void testSetMusique() {
        ...
        jeu = new Jeu(new Joueur(Camp.ELEPHANT), new Joueur(Camp.RHINOCEROS), false, false, false, false, false, false,
                false, null, null, null, null, musique, false,false,false);
