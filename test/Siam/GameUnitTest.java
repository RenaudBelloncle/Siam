...
public class GameUnitTest {
    ...
    public void testGetJoueurs() {
        ...
        game = new Game(joueurs[0], joueurs[1], false, false, false, false, false, false, null, null, null);
    ...
    public void testIsSortirPiece() {
        game = new Game(new Joueur(Camp.ELEPHANT), new Joueur(Camp.RHINOCEROS), false, false, false, false, false, false, null, null, null);
    ...
    public void testGetJoueurActif() {
        ...
        game = new Game(joueur1, joueur2, false, false, false, false, false, false, null, null, null);
    ...
    public void testGetAnimalSelectionnee() {
        ...
        game = new Game(new Joueur(Camp.ELEPHANT), new Joueur(Camp.RHINOCEROS), false, false, false, false, false, false, animal, null, null);
